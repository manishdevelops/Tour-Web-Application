        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
            ...
            <div className="mt-12 grid grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-6">
                <div className='overflow-hidden rounded-lg'>
                    ...
                    />
                    <div className='my-4'>
                        <h2 className='font-bold text-xl text-gray-900'>Experince Cultural wonders</h2>
                ...
                <div className='overflow-hidden rounded-lg'>
                    ...
                    />
                    <div className='my-4'>
                        <h2 className='font-bold text-xl text-gray-900'>Adventure Awaits</h2>
                ...
                <div className='overflow-hidden rounded-lg'>
                    ...
                    />
                    <div className='my-4'>
                        <h2 className='font-bold text-xl text-gray-900'>Beach Gataways</h2>
                ...
                <div className='overflow-hidden rounded-lg'>
                    ...
                    />
                    <div className='my-4'>
                        <h2 className='font-bold text-xl text-gray-900'>City Excursions </h2>
                ...
                <div className='overflow-hidden rounded-lg'>
                    ...
                    />
                    <div className='my-4'>
                        <h2 className='font-bold text-xl text-gray-900'>Natural Escapes</h2>
                ...
                <div className='overflow-hidden rounded-lg'>
                    ...
                    />
                    <div className='my-4'>
                        <h2 className='font-bold text-xl text-gray-900'>Wildlife Safari</h2>
                ...
                <div className='overflow-hidden rounded-lg'>
                    ...
                    />
                    <div className='my-4'>
                        <h2 className='font-bold text-xl text-gray-900'>Live Again History</h2>
                ...
                <div className='overflow-hidden rounded-lg'>
                    ...
                    />
                    <div className='my-4'>
                        <h2 className='font-bold text-xl text-gray-900'>Enjoy Hill Stations</h2>
                ...
                <div className='overflow-hidden rounded-lg'>
                    ...
                    />
                    <div className='my-4'>
                        <h2 className='font-bold text-xl text-gray-900'>Beautiful Sightseeing</h2>
