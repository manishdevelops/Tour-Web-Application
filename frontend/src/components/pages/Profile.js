    ...
    return (
        <div className='p-3 max-w-lg mx-auto'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                ...
                {
                    currentUser.role === 'admin' && <Link to='/create-tour' className='bg-green-500 text-white rounded-lg p-3 uppercase hover:opacity-80 text-center'>create a new tour</Link>
                }
            </form>
